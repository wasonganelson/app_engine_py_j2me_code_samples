...
$('#mapagentatm').live('pageshow',function(event, ui)
{
  ...
  navigator.geolocation.getCurrentPosition(getlocation1, function error()
    {
        ...
        window.location = "/mpesapointsaround?userlatitude=-4.0400224&userlongitude=39.6570464"
    },
    {enableHighAccuracy:true});
}
...
function getlocation1(position)
{
  var latitude = position.coords.latitude;
  var longitude = position.coords.longitude;
  window.location = "/mpesapointsaround?userlatitude="+latitude+"&userlongitude="+longitude
}
