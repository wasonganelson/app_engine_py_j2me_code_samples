   ...
   def get(self):
      ...
      if not queryresults:
		...
		<div class="newsarticlesummaryendline"></div>'''%(article.key(),article.content[:300],article.key(),timestamper.timestamper(article.timestamp),article.views,article.author)
         ...
         if queryresults :
            morearticleslink = '<div><a class="newsarticlesummarytimestamp" href="/eventspage?offset=%d"><br/>more articles...</a></div>'%(offset+10)
         #create content ...
